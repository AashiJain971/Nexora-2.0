...
const riskOptions = [
  { value: 'fire', label: 'Fire & Allied Perils', description: 'Fire, explosion, lightning damage' },
  { value: 'theft', label: 'Theft & Burglary', description: 'Asset theft and burglary protection' },
  { value: 'cyber', label: 'Cyber Security', description: 'Data breach, cyber fraud protection' },
  { value: 'liability', label: 'Public Liability', description: 'Third-party injury and property damage' },
  { value: 'employee_welfare', label: 'Employee Health', description: 'Group health insurance for staff' },
  { value: 'natural_disasters', label: 'Natural Disasters', description: 'Earthquake, flood, cyclone coverage' },
  { value: 'transport', label: 'Goods in Transit', description: 'Transportation and logistics risks' },
];
...
export function InsuranceHubModal({ open, onOpenChange }: InsuranceHubModalProps) {
  const [currentStep, setCurrentStep] = useState<'dashboard' | 'assessment' | 'recommendations' | 'policies'>('dashboard');
  ...
  const handleRiskAssessment = async () => {
    if (!riskAssessment.business_type || !riskAssessment.industry || riskAssessment.risk_concerns.length === 0) {
      toast({
      ...
      <DialogContent className="max-w-7xl max-h-[95vh] overflow-y-auto">
        <DialogHeader>
          ...
          <p className="text-muted-foreground">
            Discover, compare, and manage legally compliant insurance policies for your business
          </p>
        </DialogHeader>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {formatCurrency(userPolicies.reduce((sum, p) => sum + p.coverage_amount, 0))}
                    </p>
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-4">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground">IRDAI Compliant</p>
                    <p className="text-2xl font-bold">
                      {userPolicies.filter(p => p.legal_compliance).length}/{userPolicies.length}
                    </p>
                  </div>
                </div>
              </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="p-6 border-teal-accent/20 bg-gradient-to-r from-teal-accent/5 to-transparent">
                ...
                <CardContent className="p-0">
                  <p className="text-sm text-muted-foreground mb-4">
                    Assess your business risks and get personalized insurance recommendations 
                    based on IRDAI-approved policies.
                  </p>
                  <Button 
              ...
              <Card className="p-6 border-orange-accent/20 bg-gradient-to-r from-orange-accent/5 to-transparent">
                ...
                <CardContent className="p-0">
                  <p className="text-sm text-muted-foreground mb-4">
                    Track renewal dates, upload documents, and manage your existing 
                    insurance portfolio in one place.
                  </p>
                  <Button 
            ...
            <Card className="p-6">
              <CardHeader className="p-0 pb-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Help us understand your business to recommend the most suitable insurance policies
                </p>
              </CardHeader>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    ...
                    <Select value={riskAssessment.business_type} onValueChange={(value) => 
                      setRiskAssessment(prev => ({ ...prev, business_type: value }))
                    }>
                      <SelectTrigger>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setRiskAssessment(prev => ({ ...prev, industry: e.target.value }))}
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setRiskAssessment(prev => ({ ...prev, employee_count: parseInt(e.target.value) }))}
                  ...
                  <div>
                    <Label htmlFor="annual_revenue">Annual Revenue (Optional)</Label>
                    <Input
                      type="number"
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="space-y-2">
                      {['machinery', 'inventory', 'building', 'equipment'].map(asset => (
                        <div key={asset} className="flex items-center space-x-2">
                          <Label className="w-20 text-sm capitalize">{asset}:</Label>
                          <Input
                            type="number"
                            ...
                            onChange={(e) => setRiskAssessment(prev => ({
                              ...
                              assets: {
                                ...prev.assets,
                                [asset]: e.target.value ? parseFloat(e.target.value) : 0
                              }
                            }))}
                            placeholder="0"
                            className="flex-1"
                  ...
                  {riskOptions.map(risk => (
                    ...
                    >
                      <div className="flex items-center space-x-2">
                        <input
                          type="checkbox"
                          checked={riskAssessment.risk_concerns.includes(risk.value)}
          ...
          <div className="space-y-6">
            {riskScore > 0 && (
              <Card className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-muted-foreground">Your Business Risk Score</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {recommendations.map((rec, index) => (
                <Card key={rec.template_id} className="border-2 hover:border-teal-accent/50 transition-colors">
                  <CardHeader>
                    <div className="flex justify-between items-start">
                      <div>
                        <CardTitle className="text-lg">{rec.policy_name}</CardTitle>
                  ...
                  <CardContent>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-bold">{formatCurrency(rec.estimated_premium)}</span>
                      </div>
                      
                      <div>
                        <p className="text-sm font-medium mb-1">Covers Your Risks:</p>
                    ...
                    <div className="mt-4 pt-4 border-t">
                      <div className="flex space-x-2">
                        <Button size="sm" className="flex-1 bg-teal-accent hover:bg-teal-accent/90">
                          Get Quote
                        </Button>
            ...
            {recommendations.length === 0 && (
              <Card className="p-8 text-center">
                ...
                <p className="text-muted-foreground mb-4">
                  Complete the risk assessment to get personalized insurance recommendations.
                </p>
          ...
          <div className="space-y-6">
            ...
            {userPolicies.length > 0 ? (
              ...
              <Card className="p-8 text-center">
                ...
                <p className="text-muted-foreground mb-4">
                  Start by getting insurance recommendations based on your business risks.
                </p>
                <Button onClick={() => setCurrentStep('assessment')}>
                  Get Recommendations
                </Button>
