...
import { InvoiceManagementModal } from "@/components/features/invoice-management-modal-fixed";
...
export default function Dashboard() {
  ...
  const loanProgress = activeLoan
    ? (parseInt(activeLoan.repaidAmount) /
        parseInt(activeLoan.disbursedAmount)) *
      100
    : 0;
  ...
  return (
    <div className="pt-16 min-h-screen bg-background">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex space-x-4">
            <Link href="/profile">
              <Button
                variant="outline"
                className="border-teal-accent text-teal-accent hover:bg-teal-accent hover:text-background"
              >
                View Profile
              </Button>
            </Link>
            ...
            <Button
              onClick={() => {
                console.log(
                  "🔘 MAIN Dashboard Invoice Management button clicked!"
                );
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card className="p-6">
            ...
            <div className="flex items-center gap-2 mb-2">
              <div className="text-3xl font-bold text-green-accent">
                {creditScore}
              </div>
            ...
            <div className="mt-4 p-3 bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-md text-xs">
              ...
              <div className="text-slate-700 dark:text-slate-300">
                Score: {creditScore} | Category: {category}
              </div>
              <div className="text-slate-700 dark:text-slate-300">
                Total Invoices: {totalInvoices} | Loading:{" "}
                {creditLoading ? "Yes" : "No"}
              </div>
              <div className="text-slate-700 dark:text-slate-300">
          ...
          <Card className="p-6">
            ...
            <div className="text-3xl font-bold text-orange-accent mb-2">
              ₹42K
            </div>
            <div className="text-sm text-muted-foreground">
              +18% from last month
          ...
          <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {loan.lenderName} • {loan.interestRate}% APR
                        </p>
                      </div>
                      <Badge
                        className={
            ...
            <Card className="p-6">
              <h3 className="text-xl font-semibold mb-6">
                How MSME Booster Solves Your Problems
              </h3>
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-border">
                      <th className="text-left py-3 text-red-400">
                        Traditional Problems
                      </th>
                      <th className="text-left py-3 text-green-accent">
                        Our Solutions
                      </th>
                    </tr>
                  </thead>
                    ...
                    <tr className="border-b border-border">
                      <td className="py-4">
                        <div className="flex items-start space-x-2">
                          ...
                          <span>
                            Difficulty getting loans without credit history
                          </span>
                        </div>
                      </td>
                      <td className="py-4">
                        <div className="flex items-start space-x-2">
                          ...
                          <span>
                            AI-powered creditworthiness using business data
                          </span>
                        </div>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="py-4">
                        <div className="flex items-start space-x-2">
                          <AlertCircle className="w-4 h-4 text-red-400 mt-1" />
                          <span>
                            Limited market reach and buyer connections
                          </span>
                        </div>
                      </td>
                      <td className="py-4">
                    ...
                    <tr className="border-b border-border">
                      ...
                      <td className="py-4">
                        <div className="flex items-start space-x-2">
                          <CheckCircle className="w-4 h-4 text-green-accent mt-1" />
                          <span>
                            Integrated CRM, ERP, and analytics dashboard
                          </span>
                        </div>
                      </td>
                    </tr>
                    <tr className="border-b border-border">
                      ...
                      <td className="py-4">
                        <div className="flex items-start space-x-2">
                          <CheckCircle className="w-4 h-4 text-green-accent mt-1" />
                          <span>
                            Blockchain smart contracts with automated escrow
                          </span>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="py-4">
                        <div className="flex items-start space-x-2">
                          <CheckCircle className="w-4 h-4 text-green-accent mt-1" />
                          <span>
                            Video learning platform with AI chatbot mentor
                          </span>
                        </div>
                      </td>
                    </tr>
      ...
      <InvoiceUploadModal
        ...
        onUploadComplete={() => {
          console.log(
            "🔄 Invoice uploaded, refreshing dashboard credit score..."
          );
          refreshCreditScore();
        }}
      />
      <InvoiceManagementModal
        open={activeModal === "invoiceManagement"}
        onOpenChange={closeModal}
      />
      <LoanDiscoveryModal
        open={activeModal === "loans"}
        onOpenChange={closeModal}
      />
      <MarketplaceModal
        open={activeModal === "marketplace"}
        onOpenChange={closeModal}
      />
      <InsuranceHubModal
