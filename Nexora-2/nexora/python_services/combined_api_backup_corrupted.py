...
def generate_policy_content(policy_type: str, business: dict, language: str = "en") -> str:
    ...
    if language == "hi" and policy_type == "privacy_policy":
        return f"""# गोपनीयता नीति

**प्रभावी तिथि:** {current_date}

## परिचय
**{business_name}** में आपका स्वागत है। यह गोपनीयता नीति बताती है कि हम आपकी व्यक्तिगत जानकारी कैसे एकत्र, उपयोग और सुरक्षित करते हैं।

## हम कौन सी जानकारी एकत्र करते हैं
- व्यक्तिगत विवरण (नाम, ईमेल, फोन)
- उपयोग की जानकारी
- तकनीकी डेटा

## हम आपकी जानकारी का उपयोग कैसे करते हैं
- सेवाएं प्रदान करने के लिए
- ग्राहक सहायता के लिए
- सुरक्षा सुनिश्चित करने के लिए

## डेटा सुरक्षा
हम आपकी व्यक्तिगत जानकारी की सुरक्षा के लिए उद्योग-मानक सुरक्षा उपाय अपनाते हैं।
...
---
*अंतिम अद्यतन: {current_date}*
"""
    
    elif language == "hi" and policy_type == "terms_conditions":
        return f"""# नियम और शर्तें

**प्रभावी तिथि:** {current_date}

## शर्तों की स्वीकृति
**{business_name}** की सेवाओं का उपयोग करके, आप इन नियमों से सहमत होते हैं।

## सेवा का उपयोग
- सेवा का उपयोग केवल वैध उद्देश्यों के लिए करें
- अवैध गतिविधियों में संलग्न न हों
